...
from src.ner.transformers.utils import InputExample, read_examples_from_file, get_examples_from_df, \
    convert_examples_to_features


class NERModel:
    def __init__(
            self, model_type, model_name, args, labels=None, use_cuda=True, cuda_device=-1, **kwargs,
    ):
        """
